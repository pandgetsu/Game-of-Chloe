...
public class VNSelection extends VNDialogue
{
    ...
    private int bondChange1, bondChange2, bondChange3;
    ...
    public VNSelection()
    {
        ...
        response2 = "";
        response3 = "";
        bondChange1 = bondChange2 = bondChange3 = 0;
    }
    /**
    ...
    public void setBond1(String b)
    {
        bondChange1 = Integer.parseInt(b);       
    }
    public void setBond2(String b)
    {
        bondChange2 = Integer.parseInt(b);
    }
    public void setBond3(String b)
    {
        bondChange3 = Integer.parseInt(b);
    }
