...
public class Assets 
{
    ...
    public static BufferedImage chloeEntity;
    ...
    public static void init()
    {
        ...
        mainCharacter_standing = new BufferedImage[3];
        mainCharacter_standing[0] = sheet.cropImage(0, HEIGHT * 8, WIDTH, HEIGHT);
        mainCharacter_standing[1] = sheet.cropImage(0, HEIGHT * 8, WIDTH, HEIGHT);
        mainCharacter_standing[2] = sheet.cropImage(0, HEIGHT * 8, WIDTH, HEIGHT);
        
        //sprite croppings for main character walking up animation
        mainCharacter_UpWalk = new BufferedImage[2];
        //mainCharacter_UpWalk[0] = sheet.cropImage(WIDTH * 6, HEIGHT * 6, WIDTH, HEIGHT);
        mainCharacter_UpWalk[0] = sheet.cropImage(WIDTH * 7, HEIGHT * 8, WIDTH, HEIGHT);
        mainCharacter_UpWalk[1] = sheet.cropImage(WIDTH * 8, HEIGHT * 8, WIDTH, HEIGHT);
        
        //sprite croppings for main character walking down animation
        mainCharacter_DownWalk = new BufferedImage[2];
    //  mainCharacter_DownWalk[0] = sheet.cropImage(0, HEIGHT * 6, WIDTH, HEIGHT);
        mainCharacter_DownWalk[0] = sheet.cropImage(WIDTH, HEIGHT * 8, WIDTH, HEIGHT);
        mainCharacter_DownWalk[1] = sheet.cropImage(WIDTH * 2, HEIGHT * 8, WIDTH, HEIGHT);
        
        //sprite croppings for main character walking left animation
        mainCharacter_LeftWalk = new BufferedImage[2];
    //  mainCharacter_LeftWalk[0] = sheet.cropImage(WIDTH * 9, HEIGHT * 6, WIDTH, HEIGHT);
        mainCharacter_LeftWalk[0] = sheet.cropImage(WIDTH * 10, HEIGHT * 8, WIDTH, HEIGHT);
        mainCharacter_LeftWalk[1] = sheet.cropImage(WIDTH * 11, HEIGHT * 8, WIDTH, HEIGHT);
        
        //sprite croppings for main character walking right animation
        mainCharacter_RightWalk = new BufferedImage[2];
        mainCharacter_RightWalk[0] = sheet.cropImage(WIDTH * 3, HEIGHT * 8, WIDTH, HEIGHT);
        mainCharacter_RightWalk[1] = sheet.cropImage(WIDTH * 4, HEIGHT * 8, WIDTH, HEIGHT);
        //mainCharacter_RightWalk[2] = sheet.cropImage(WIDTH * 5, HEIGHT * 6, WIDTH, HEIGHT);
        ...
        badTile = sheet.cropImage(WIDTH * 4, 0, WIDTH, HEIGHT);
        
        //girl entity
        //chloeEntity = sheet.cropImage(0, HEIGHT * 4, WIDTH, HEIGHT);
        chloeEntity = sheet.cropImage(WIDTH, HEIGHT * 4, WIDTH, HEIGHT);
